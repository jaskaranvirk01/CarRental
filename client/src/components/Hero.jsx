...
const Hero = () => {
    ...
    const { navigate, axios, pickupDate, setPickupDate, returnDate, setReturnDate } = useAppContext();
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}
            ...
            <motion.form initial={{ y: 50, scale: 0.95, opacity: 0 }} animate={{ y: 0, opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.4 }}
